  ...
  <div class="tool">
    <div class="tool-avatar">
      <div class="tool-avatar-img" @click="showUserInfo('showUserModal')">
        ...
        <img v-if="user" src="~@/assets/img/1.jpg" alt="" />

      </div>
      <div class="tool-avatar-name">{{ "Nick" }}</div>
    </div>
    <a-tooltip placement="topLeft" arrow-point-at-center>
      <div slot="title">
        <div>Please chat civilly</div>
        <div>Screenshot paste can send pictures</div>
      </div>
      ...
      <div class="tool-user">
        ...
        >
          <!-- <a-avatar :src="user.avatar" class="img" :size="120"></a-avatar> -->
            <a-avatar src="~@/assets/img/1.jpg" class="img" :size="120"></a-avatar>
        ...
        <div class="tool-user-info">
          ...
          <a-input class="tool-user-input" v-model="username" placeholder="please enter username"></a-input>
          <a-button type="primary" @click="changeUserName">confirm</a-button>
        </div>
        <div class="tool-user-info">
          <div class="tool-user-title">change password</div>
          <a-input-password class="tool-user-input" v-model="password" placeholder="please enter password"></a-input-password>
