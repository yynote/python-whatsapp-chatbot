  ...
  <div class="search">
    <div class="search-select">
      ...
      <!-- <a-dropdown class="search-dropdown">
        ...
        <a-menu slot="overlay">
          <a-menu-item>
            <div @click="() => (visibleAddGroup = !visibleAddGroup)">create group</div>
          </a-menu-item>
          <a-menu-item>
    ...
    <a-modal v-model="visibleAddGroup" footer="" title="create group">
      <div style="display:flex">
        <a-input v-model="groupName" placeholder="Please enter the group name"></a-input>
        <a-button @click="addGroup" type="primary">Sure</a-button>
      </div>
    </a-modal>
    <a-modal v-model="visibleJoinGroup" footer="" title="search group">
      <div style="display:flex" v-if="visibleJoinGroup">
        ...
        <a-button @click="joinGroup" type="primary">Join the group</a-button>
      </div>
    </a-modal>
