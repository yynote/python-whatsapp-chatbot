<template>
  ...
  >
    ...
    <div class="chat-part3">
      ...
      <genal-message v-if="temp_activeRoom"></genal-message>
    </div>
...
export default class GenalChat extends Vue {
  ...
  @chatModule.Mutation('set_select_users') _setSelectUsers: Function;
  ...
  temp_activeRoom: Friend & Group
  created() {
    this.temp_activeRoom = {
    userId: 'tiger',
    username: 'JohnDoe',
    avatar: '',
    role: '1',
    ...
    messages: [{
      userId: 'man',
      friendId: 'tough',
      content: 'you and i are talking about our lives. I am so happy to see you again',
      messageType: 'text',
      time: 124,
      type: '123',
      }],
